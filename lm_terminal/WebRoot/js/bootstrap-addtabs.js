    ...
    drop: function () {
        ...
        element.append(dropdown.find('li'))
            ...
            .each(function () {
            	...
            	console.info("element.width():"+element.width());
            	console.info("$(this).position().left:"+$(this).position().left);
            	console.info("$(this).width():"+$(this).width());
            	console.info("------------------------------------------------------");
            	console.info("element.width() - $(this).position().left - $(this).width():" + (element.width() - $(this).position().left - $(this).width()));*/
                if (element.width() - $(this).position().left - $(this).width() < 40) {
