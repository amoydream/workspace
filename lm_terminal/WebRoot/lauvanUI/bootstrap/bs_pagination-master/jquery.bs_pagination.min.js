						...
						if (C.bootstrap_version == "3") {
							...
							if (C.showGoToPage
								...
								w += '<span class="input-group-addon" title="'
										...
										+ '" id="onChangePageClick"></i></span>';
								w += '<input id="' + x
										+ '" name="onChangePageInput" type="text" class="'
							...
							if (C.showRowsPerPage) {
								...
								w += '<span class="input-group-addon" title="'
										...
										+ '" id="onChangeRowClick"></i></span>';
								w += '<input id="' + B + '" name="onChangeRowInput" value="'
										+ C.rowsPerPage
										+ '" type="text" class="'
	...
	var f = function(F, k, g, J, u) {
		...
		if (B.showRowsInfo && B.showRowsDefaultInfo) {
			var o = ((B.currentPage - 1) * B.rowsPerPage) + 1, n = Math.min(o
					+ B.rowsPerPage - 1, B.totalRows), A = "<h5>" + B.totalRows
					+ " " + rsc_bs_pag.rows_info_records + "</h5>", j = c(
