...
<body>
	<form id="emeOrgan_addform" class="form-horizontal" role="form">
		...
		<fieldset>
			<div class="form-group">
				...
				<div class="col-sm-4 input-message">
					...
					<input class="form-control" id="eo_name" name="eo_name" type="text"
				...
				<div class="col-sm-4 input-message">
				<div class='input-group date'>
					<input class="form-control" id="eo_sname" name="eo_sname" type="text"
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<div class='input-group date'>
						<input class="form-control" id="eo_englishname" name="eo_englishname" type="text"
						placeholder="输入英文名称" />
					</div>
				</div>
				...
				<div class="col-sm-4">
					<div class='input-group date'>
						<input class="form-control" id="eo_no" name="eo_no" type="text"
						placeholder="输入序号" />
					</div>
				</div>
			</div>
...
$('#emeOrgan_addform').bootstrapValidator();
function emeOrganAdd_submitForm(index,window) {
	$('#emeOrgan_addform').bootstrapValidator('validate');
	if($('#emeOrgan_addform').data('bootstrapValidator').isValid()){
		$.post('emeplan/emeOrgan/add', $('#emeOrgan_addform').serialize(), function(j) {
			if(j.success){
