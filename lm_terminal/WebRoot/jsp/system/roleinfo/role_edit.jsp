...
<form id="role_editform" class="form-horizontal" role="form">
<input type="hidden" name="ro_Id" value="${role.ro_Id }"/>
		<fieldset>
			<div class="form-group" style="margin-left: 0px; margin-right: 0px;">
				<label class="col-sm-2 control-label" for="ro_Code">编码</label>
				<div class="col-sm-4 input-message">
					<input class="form-control" id="ro_Code" name="ro_Code" value="${role.ro_Code }" type="text" 
					placeholder="输入编码"/>
				</div>
				<label class="col-sm-2 control-label" for="ro_Name"><span style="color: red;">*</span>角色名称</label>
				<div class="col-sm-4 input-message">
					<input class="form-control" id="ro_Name" name="ro_Name" value="${role.ro_Name }" type="text"
			...
			<div class="form-group" style="margin-left: 0px; margin-right: 0px;">
				...
				<div class="col-sm-10">
					<input class="form-control" id="ro_Remark"
						name="ro_Remark" value="${role.ro_Remark }" type="text" placeholder="输入备注" />
				</div>
			</div>
		</fieldset>
		...
		<fieldset>
		<legend>权限选择</legend>
		<input type="hidden" id="moduleids" name="moids" value="${moduleids }"/>
		<div class="form-group" style="margin-left: 0px; margin-right: 0px;">
		<div class="col-sm-10">
