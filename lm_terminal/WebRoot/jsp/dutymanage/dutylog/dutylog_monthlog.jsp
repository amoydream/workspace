...
<div style="margin-bottom: 15px;">
	<form class="form-inline" action="dutymanage/dutylog/monthlog" method="post">
		...
		<div class="form-group">
			<label for="duty_month">值班月份</label>
			<input type="text" id="duty_month" name="duty_month" class="form-control" placeholder="值班月份"
				value="${dutyLogVo.duty_month_str}">
		</div>
