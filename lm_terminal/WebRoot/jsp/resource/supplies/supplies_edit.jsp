...
<form id="suppliesEditForm" class="form-horizontal" role="form">
<input type="hidden" name="su_Id" value="${supplies.su_Id }"/>
		<fieldset>
			<div class="form-group">
				<label class="col-sm-2 control-label" for="su_Code"><span style="color:red">* </span>物资编号</label>
				<div class="col-sm-4 input-message">
					<input class="form-control" id="su_Code" name="su_Code" value="${supplies.su_Code }" type="text"
				...
				<div class="col-sm-4 input-message">
					<input class="form-control" id="su_Name" name="su_Name" value="${supplies.su_Name }" type="text"
						placeholder="必填项" data-bv-trigger="keyup" required="required" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4 input-message">
					<input class="form-control" id="su_Type" name="su_Type" value="${supplies.su_Type}" type="text"/>
				</div>
				<label class="col-sm-2 control-label" for="su_Size">物资规格</label>
				<div class="col-sm-4 input-message">
					<input class="form-control" id="su_Size" name="su_Size" value="${supplies.su_Size }" type="text" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label" for="su_Measureunit">计量单位</label>
				<div class="col-sm-4 input-message">
					<input class="form-control" id="su_Measureunit" name="su_Measureunit" value="${supplies.su_Measureunit }" type="text" />
				</div>
				<label class="col-sm-2 control-label" for="su_Safetystock">安全库存</label>
				<div class="col-sm-4 ">
					<input class="form-control" id="su_Safetystock" name="su_Safetystock" value="${supplies.su_Safetystock }" type="text"
						 />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4 ">
					<input class="form-control" id="su_Remark" name="su_Remark" value="${supplies.su_Remark }" type="text"
						/>
				</div>
			</div>
