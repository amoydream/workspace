...
<body>
	<form id="expertAddForm" class="form-horizontal" role="form">
		<fieldset style="margin-top: 15px">
			<div class="form-group">
				...
				<div class="col-sm-2 input-message">
					<input type="hidden" id="typeId" name="ex_Typeid.ext_Id"/> <input
						class="form-control" name="typeName" id="typeName" type="text"
				...
				<div class="col-sm-2 input-message">
					<input class="form-control" id="ex_Name" name="ex_Name" type="text" data-bv-trigger="keyup" required="required"/>
				</div>
				<label class="col-sm-1 control-label" for="ex_Sex">性别</label>
				<div class="col-sm-2 ">
					<input type="radio" id="ex_Sex" name="ex_Sex" value="1"
					checked="checked" />男 <input type="radio" name="ex_Sex" value="0" />女
				</div>
				<label class="col-sm-1 control-label" for="ex_Borndate">出生日期</label>
				<div class="col-sm-2">
					<div class='input-group'>
						<input class="form-control" id="ex_Borndate" name="ex_Borndate"
							type="text" /><span
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input class="form-control" id="ex_Graduateschool"
						name="ex_Graduateschool" type="text" />
				</div>
				<label class="col-sm-1 control-label" for="ex_Graduatetime">毕业时间</label>
				<div class="col-sm-2">
					<div class='input-group'>
						<input class="form-control" id="ex_Graduatetime" name="ex_Graduatetime"
							type="text" /><span
							class="input-group-addon"> <span
							class="glyphicon glyphicon-calendar"></span>
						</span>
			...
			<div class="form-group">
				<label class="col-sm-1 control-label" for="ex_Workdate">参加工作时间</label>
				<div class="col-sm-2">
					<div class='input-group'>
						<input class="form-control" id="ex_Workdate" name="ex_Workdate"
							type="text" /><span
							class="input-group-addon"> <span
							class="glyphicon glyphicon-calendar"></span>
						</span>
				...
				<div class="col-sm-2">
					<input class="form-control" id="ex_Healthstatus"
						name="ex_Healthstatus" type="text" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-1 control-label" for="ex_Deptid"><span style="color:red">* </span>所属单位</label>
				<div class="col-sm-2 input-message">
					<input type="hidden" id="organId" name="ex_Deptid.or_id" /> <input
						class="form-control" name="organName" id="organName" type="text"
			...
			<div class="form-group">
				<label class="col-sm-1 control-label" for="ex_Position">职务</label>
				<div class="col-sm-2">
				...
				<div class="col-sm-2">
					<input class="form-control" id="ex_Registeplace"
						name="ex_Registeplace" type="text" />
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5 ">
					<input class="form-control" id="ex_Familyaddress"
						name="ex_Familyaddress" type="text" />
				</div>
	...
	<div class="modal-footer">
		...
		<button type="submit" class="btn btn-primary" id="expertAddBtn" onclick="add();">添加</button>
	</div>
