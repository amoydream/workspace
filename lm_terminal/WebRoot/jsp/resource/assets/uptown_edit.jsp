...
<body>
	...
	<div class="modal-body">
		<form class="form-horizontal" id="resEditForm">
			<input type="hidden" name="up_Id" value="${uptown.up_Id }" />
			<div class="form-group ">
				...
				<div class="col-sm-4 input-message">
					<input class="form-control" id="up_Name" name="up_Name"
						value="${uptown.up_Name }" type="text" placeholder="名称" data-bv-trigger="keyup" required="required" />
				</div>
				<label class="col-sm-2 control-label" for="up_area">占地面积</label>
				<div class="col-sm-4 ">
					<input class="form-control" id="up_Area" name="up_Area" value="${uptown.up_Area }" type="text" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<div class="input-group">
						<span class="input-group-btn">
							...
							value="${uptown.up_Longitude}" type="text" placeholder="经度"/>
					</div>
				</div>
				...
				<div class="col-sm-4 ">
					<div class="input-group">
						<span class="input-group-btn">
							...
							value="${uptown.up_Latitude}" type="text" placeholder="纬度" />
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" id="up_Linkman" name="up_Linkman"
						value="${uptown.up_Linkman }" type="text" placeholder="联系人" />
				</div>
				...
				<div class="col-sm-4">
					<input class="form-control" id="up_Linkmantel" name="up_Linkmantel"
						value="${uptown.up_Linkmantel }" type="text"
			...
			<div class="form-group">
				...
				<div class="col-sm-10 input-message">
					<input class="form-control" id="up_Address" name="up_Address"
						value="${uptown.up_Address }" type="text" placeholder="地址" data-bv-trigger="keyup" required="required"/>
				</div>
			</div>
