...
<body>
	...
	<div class="modal-body">
		<form class="form-horizontal" id="resEditForm">
			<input type="hidden" name="re_Id" value="${reservoir.re_Id }" />
			<div class="form-group ">
				...
				<div class="col-sm-4 input-message">
					<input class="form-control" id="re_Name" name="re_Name"
						value="${reservoir.re_Name }" type="text" placeholder="名称" data-bv-trigger="keyup" required="required" />
				</div>
				<label class="col-sm-2 control-label" for="re_area">占地面积</label>
				<div class="col-sm-4 ">
					<input class="form-control" id="re_Area" name="re_Area" value="${reservoir.re_Area }" type="text" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<div class="input-group">
						<span class="input-group-btn">
							...
							value="${reservoir.re_Longitude}" type="text" placeholder="经度"/>
					</div>
				</div>
				...
				<div class="col-sm-4 ">
					<div class="input-group">
						<span class="input-group-btn">
							...
							value="${reservoir.re_Latitude}" type="text" placeholder="纬度" />
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" id="re_Linkman" name="re_Linkman"
						value="${reservoir.re_Linkman }" type="text" placeholder="联系人" />
				</div>
				...
				<div class="col-sm-4">
					<input class="form-control" id="re_Linkmantel" name="re_Linkmantel"
						value="${reservoir.re_Linkmantel }" type="text"
			...
			<div class="form-group">
				...
				<div class="col-sm-10 input-message">
					<input class="form-control" id="re_Address" name="re_Address"
						value="${reservoir.re_Address }" type="text" placeholder="地址" data-bv-trigger="keyup" required="required"/>
				</div>
			</div>
