...
<div id="container"></div>
	<div class="modal-body">
		<form id="dangerAddForm" class="form-horizontal" role="form">
			...
			<div class="form-group">
				...
				<div class="col-sm-4 input-message">
					<input class="form-control" id="da_Name" name="da_Name" type="text"
						placeholder="必填项"  />
				</div>
				<label class="col-sm-2 control-label" for="da_Dept">所属单位</label>
				<div class="col-sm-4 ">
					<input class="form-control" id="da_Dept" name="da_Dept"
						type="text" />
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label" for="da_Longitude"><span style="color:red">* </span>经度</label>
				<div class="col-sm-4 input-message">
					<div class="input-group">
						...
						</span> <input id="longitude" class="form-control" name="da_Longitude"
							type="text" placeholder="经度"  />
					</div>
				</div>
				<label class="col-sm-2 control-label" for="da_Latitude"><span style="color:red">* </span>纬度</label>
				<div class="col-sm-4 input-message">
					<div class="input-group">
						<span class="input-group-btn">
							<button class="btn btn-default" type="button" onclick="getMap()">
						...
						</span> <input id="latitude" class="form-control" name="da_Latitude"
			...
			<div class="form-group">
				...
				<div class="col-sm-10 input-message">
					<input class="form-control" id="da_Address" name="da_Address"
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" id="da_Remark" name="da_Remark"
						type="text" />
				</div>
			</div>
