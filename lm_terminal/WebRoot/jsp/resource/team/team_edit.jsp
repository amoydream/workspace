...
<div class="modal-body">
	<form class="form-horizontal" id="teamEditForm">
		<input type="hidden" name="te_Id" value="${team.te_Id }" />
		<div class="form-group">
			<label class="col-sm-2 control-label" for="te_Name">名称</label>
			<div class="col-sm-4 input-message">
				<input class="form-control" id="te_Name" name="te_Name"
					value="${team.te_Name}" type="text" placeholder="名称"
					 />
			</div>
			<label class="col-sm-2 control-label" for="te_Director">负责人</label>
			<div class="col-sm-4 input-message">
				<input class="form-control" id="te_Director" name="te_Director"
					value="${team.te_Director}" type="text" placeholder="负责人"
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input class="form-control" id="te_Directortel" name="te_Directortel"
					value="${team.te_Directortel}" type="text" />
			</div>
			<label class="col-sm-2 control-label" for="te_Directorphone">负责人手机</label>
			<div class="col-sm-4 input-message">
				<input class="form-control" id="te_Directorphone"
					name="te_Directorphone" value="${team.te_Directorphone}" type="text"
					 />
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label" for="te_Deptid">所属单位</label>
			<div class="col-sm-4 input-message">
				<input type="hidden" id="organId" name="sh_Deptid" value="${team.te_Deptid.or_id}"/> <input
						class="form-control" id="organName" name="organName" type="text" value="${team.te_Deptid.or_name}"
			...
			<div class="col-sm-4">
				<input class="form-control" id="te_Membernum" name="te_Membernum"
					value="${team.te_Membernum}" type="text" placeholder="成员数量" />
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input class="form-control" id="te_Linkmantel"
					name="te_Linkmantel" value="${team.te_Linkmantel}" type="text"
					placeholder="联系人电话" />
			</div>
			<label class="col-sm-2 control-label" for="te_Fax">传真</label>
			<div class="col-sm-4">
				<input class="form-control" id="te_Fax" name="te_Fax"
					value="${team.te_Fax}" type="text" placeholder="传真" />
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-4 input-message">
				<div class="input-group">
					...
					</span> <input id="longitude" class="form-control" name="te_Longitude" value="${team.te_Longitude }"
			...
			<div class="col-sm-4 input-message">
				<div class="input-group">
					...
					</span> <input id="latitude" class="form-control" name="te_Latitude" value="${team.te_Latitude }"
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input class="form-control" id="te_Teamjob" name="te_Teamjob"
					value="${team.te_Teamjob}" type="text" placeholder="队伍职责" />
			</div>
			...
			<div class="col-sm-4">
				<input class="form-control" id="te_Teamscribe" name="te_Teamscribe"
					value="${team.te_Teamscribe}" type="text" placeholder="队伍描述" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input class="form-control" id="te_Equipment" name="te_Equipment"
					value="${team.te_Equipment}" type="text" placeholder="装备描述" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input class="form-control" id="te_Remark" name="te_Remark"
					value="${team.te_Remark}" type="text" placeholder="备注" />
			</div>
		</div>
	</form>
