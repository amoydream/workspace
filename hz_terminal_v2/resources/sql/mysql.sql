...
create table T_BUS_MAPCONFIG{
  ID  INT(11) NOT NULL AUTO_INCREMENT,
  LNG        DOUBLE COLLATE utf8_bin DEFAULT NULL COMMENT '经度',
  LAT        DOUBLE COLLATE utf8_bin DEFAULT NULL COMMENT '纬度',
  ZOOM       INT(11) COLLATE utf8_bin DEFAULT NULL COMMENT '放大级数',
  APIURL     VARCHAR(200) COLLATE utf8_bin DEFAULT NULL COMMENT 'api地址',
  GISURL     VARCHAR(200) COLLATE utf8_bin DEFAULT NULL COMMENT 'gis地址',
  ONLINEMAP  VARCHAR(1) COLLATE utf8_bin DEFAULT NULL COMMENT '0:arcgis地图  1:百度地图',
  PRIMARY KEY (ID)
}
...
insert into t_sys_module (ID, NAME, ADDRESS, ORDERINDEX, P_ID, MARK, OPENTYPE, ICONCLASS, MODELTYPE, DESCRIPTION, USABLE)
values (88, '地图管理', '', 5, 8, 'gismanage', '0', 'icon-world', '0', '', '1');

insert into t_sys_module (ID, NAME, ADDRESS, ORDERINDEX, P_ID, MARK, OPENTYPE, ICONCLASS, MODELTYPE, DESCRIPTION, USABLE)
values (89, '地图配置', 'Main/geographic/manage', 1, 88, 'gisconfig', '0', 'icon-worldconnect', '0', '', '1');

insert into t_sys_module (ID, NAME, ADDRESS, ORDERINDEX, P_ID, MARK, OPENTYPE, ICONCLASS, MODELTYPE, DESCRIPTION, USABLE)
values (90, '配置查看', 'Main/geographic/manage/index', 1, 89, 'gismanageview', '0', '', '1', '', '1');
