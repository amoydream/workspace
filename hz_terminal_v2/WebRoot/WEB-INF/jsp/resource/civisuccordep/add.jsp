  ...
  <script>
  	...
  	$(function(){
		...
		function onComplete(event, queueId, fileObj, response, data){
			...
			var photohtml =  "<div id='photobox_"+obj.id+"'><input type='hidden' name='t_Civisuccordep.photo' id='phoid' value='"+obj.id+"'/><img src='" + obj.url + "' style='width:135px;height:85px;float:left;' />";
