...
function Save() {
	document.getElementById("eventDocView").WebSave();
	window.close();
}
function SaveAs(){
	document.getElementById("eventDocView").ShowDialog(3);
}
//打印
function ShowPrintDlg() {
    document.getElementById("eventDocView").ShowDialog(4); //打印对话框
}
//打开本地文件
function openLCfile(){
	document.getElementById("eventDocView").ShowDialog(1);
}
</script>
</head>
<body>
...
<div style="height: 100%;float: left;margin: 0 auto;padding: 0 auto;width: 100%;">
	<po:PageOfficeCtrl id="eventDocView" />
</div>
</form>
</body>
</html>