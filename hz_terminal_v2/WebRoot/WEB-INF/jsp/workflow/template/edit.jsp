...
$(function(){
	...
	$("#attrGrid").datagrid("loadData",${plist});
});
...
function checkUserClick(e1,e2){
	...
	$("#checkUserDialog").dialog({
	  ...
	  <div data-options="region:'north',border:false" style="height:150px;">
	 	<input name="act" type="hidden" value="upd"/>
	 	<input name="t_WF_Template.id" type="hidden" value="${t.id}"/>
	 	<input name="wfid" type="hidden" value="${t.id}"/>
	    <table class="sp-table" width="100%" cellpadding="0" cellspacing="0">
		    	<tr>
		    	<td class="sp-td1">流程名称：</td>
		    	<td><input id="fname_ds"  name="t_WF_Template.tname" type="text" class="easyui-textbox" data-options="required:true"  style="width: 200px;" value="${t.tname}"/>  </td>
		    	
		  		<td class="sp-td1">流程方式：</td>
		    	<td><select id="wftemplatetype" name="t_WF_Template.ftype" class="easyui-combobox" panelHeight="auto" code="LCFS" style="width: 100px;" data-options="value:'${t.ftype}'" ></select>
				</td>
		    	</tr>
		    	<tr>
				<td class="sp-td1">流程表单：</td>
				<td >
		    	<input type="hidden" id="wf_id" name="t_WF_Template.formid" value="${t.formid}"/>
		    	<input id="wf_formBox" name="wf_name" type="text" class="easyui-searchbox"  style="width: 200px;"  
		    	data-options="searcher:formClick,value:'${formname}'"/>    
				</td>
				<td class="sp-td1">流程类型：</td>
		    	<td><select  name="t_WF_Template.tcode" class="easyui-combobox" panelHeight="auto" code="LCLX"  style="width: 100px;" data-options="value:'${t.tcode}'"  ></select>
				</td>
		    	</tr>
		    	<tr>
		    	...
		    	<td colspan="3">
		    		...
		    		data-options="validType:'length[0,200]'"  style="width: 500px;height: 50px;" value="${t.remark}"></textarea>
		    	</td>
		    	</tr>
	    </table>
	    ...
	    <div id="lcdiv" style="width: 100%;height: 100%;">
	    </c:if>
	    <c:if test="${t.ftype!='00A'}">
