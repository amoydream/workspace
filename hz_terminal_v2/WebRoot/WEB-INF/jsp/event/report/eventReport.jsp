...
poCtrl1.setTagId("eventReportView"); //此行必须 
%>
...
function Save() {
	document.getElementById("eventReportView").WebSave();
	window.close();
}
function SaveAs(){
	document.getElementById("eventReportView").ShowDialog(3);
}
//打印
function ShowPrintDlg() {
    document.getElementById("eventReportView").ShowDialog(4); //打印对话框
}
//打开本地文件
function openLCfile(){
	document.getElementById("eventReportView").ShowDialog(1);
}
</script>
</head>
<body >
...
<div style="height: 100%;float: left;margin: 0 auto;padding: 0 auto;width: 100%;">
	<po:PageOfficeCtrl id="eventReportView" />
</div>
</form>
</body>
</html>