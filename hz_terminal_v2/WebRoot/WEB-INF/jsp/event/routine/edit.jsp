	...
	tel_addWN(phone, pname);
	 ...
	 <form id="routineform" method="post" action="<%=basePath %>Main/eventRoutine/save" style="width:100%;">
	    ...
	    <table  id="table" class="sp-table" width="100%" cellpadding="0" cellspacing="0">
		    	...
		    	<td >
		    		<input type="text" id="_evpname_r" name="t_Bus_EventInfo.ev_reporter" data-options="prompt:'请输入报告人姓名',required:true,icons:iconClear" 
		    	...
		    	<td colspan="3">
		    	<input class="easyui-combotree" name="t_Bus_EventInfo.occurarea" data-options="url:'<%=basePath%>Main/event/getoccurAreaTree',method:'get',editable:false,required:true,value:'${t.occurarea}'" style="width:180px;">
		    	（镇/街道）
