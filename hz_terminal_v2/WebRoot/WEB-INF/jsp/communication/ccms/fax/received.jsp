...
<div class="easyui-layout" data-options="fit:true">
	...
	<div data-options="region:'center',border:false">
		<table id="faxGrid_${sender}" cellspacing="0" cellpadding="0">
			<thead>
				<tr>
					<th field="OR_NAME" width="15%" sortable="true">发送部门</th>
					<th field="FAX_NUMBER" width="15%" sortable="true">传真号码</th>
					<th field="DATETIME" width="15%" sortable="true">接收时间</th>
					<th field="EV_NAME" width="20%" formatter="fax_eventLink" sortable="true">事件名称</th>
					<th field="EV_TYPE" width="15%" sortable="true">事件类型</th>
					<th field="FAXST" width="10%" formatter="fax_faxstFmt" sortable="true">传真状态</th>
					<th field="READ" width="10%" formatter="fax_readFmt" sortable="true">是否已读</th>
				</tr>
			</thead>
		</table>
	</div>
