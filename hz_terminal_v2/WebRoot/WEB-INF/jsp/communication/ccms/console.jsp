...
<div class="easyui-layout" data-options="fit:true">
	...
	padding-left: 5px; margin-bottom: 10px;"></div>
		<div data-options="border:false" style="padding: 5px;">
			...
			<button class="easyui-linkbutton" data-options="iconCls:'icon-meetingcall'" onclick="add_member('tel_mobile');">加入会议</button>
		</div>
		<div data-options="border:false" style="padding: 5px;">
			...
			<button class="easyui-linkbutton" data-options="iconCls:'icon-meetingcall'" onclick="add_member('tel_office');">加入会议</button>
		</div>
		<div data-options="border:false" style="padding: 5px;">
			...
			<button class="easyui-linkbutton" data-options="iconCls:'icon-meetingcall'" onclick="add_member('tel_home');">加入会议</button>
		</div>
		<div data-options="border:false" style="padding: 5px;">
