...
%>
	...
	$(function(){
		...
		var attrArray={
				toolbar: [
                  ...
                  { text: '位置', iconCls: 'icon-worldorbit',handler:showLocator}, '-',         
	...
	function showLocator(){
		var uid = zTree_user1.getSelectedNodes()[0].id;
		var args = '';
		if(uid!=null&&uid!=0){
			args = '?uids='+uid;
		}		
		var attrArray={
  				...
  				height:600,
  				iconCls:"icon-world",
  				href:'<%=basePath%>Main/geographic/common/openRealTimePoint'+args,
  				onClose:function(){
  					clearRealPointTimer();	
  				},
  				buttons:[
  				{
  					...
  					handler:function(){
  						clearRealPointTimer(); 
  						$("#gis1Dialog").dialog('close');
  					}
  				}
  			 ]
  			}; 
  			$.lauvan.openCustomDialog("gis1Dialog",attrArray,null,null);		
	}
