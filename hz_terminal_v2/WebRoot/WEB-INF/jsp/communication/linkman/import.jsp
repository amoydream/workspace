...
<form id="linkman_form" method="post" action="<%=basePath%>Main/linkman/importSave"
	style="width: 100%;">
	...
	<table class="sp-table" width="100%" cellpadding="0" cellspacing="0">
		    ...
		    <td>
		    <input id="telnum" name="telnum" type="text" class="easyui-textbox" data-options="required:true"  style="width: 200px;"/></td>
		    </tr>
		    <tr>
