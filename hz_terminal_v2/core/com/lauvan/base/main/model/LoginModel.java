...
public class LoginModel implements Serializable {
	...
	private String				DTMFKEY;					// 外部传真发送前选择部门按键
	...
	private boolean				isLeader;					// 是否是超级管理员
	...
	public Integer getSeatSort() {
		return seatSort;
	}

	public void setSeatSort(Integer seatSort) {
