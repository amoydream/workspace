...
define(["plugins/gis/frame/dynamicLoading.js","plugins/gis/plugins/coordtransform.js","esri/map","dojo/on","esri/graphic","esri/geometry/webMercatorUtils","esri/layers/ArcGISDynamicMapServiceLayer","esri/layers/ArcGISTiledMapServiceLayer",
	...
	var customMap=function(containerId,centerLng,centerLat,mapServiceUrl,apiUrl){
		...
		on(this.map,"load",function(){
			...
			if(me.map.getMaxZoom()!=-1)
				me.map.setZoom(Math.floor((me.map.getMaxZoom()-me.map.getMinZoom())/2));
		});
