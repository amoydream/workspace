...
<script type="text/javascript">
	...
	function exportzb(){
		var startDate = $("#startDate").datebox('getValue');
		$("#download_frame").attr("src", "Main/onduty/dutyexp?startDate="+startDate);	
	}
...
<!-- 滑动模块 -->
<div style="float:left; height:350px;overflow-y:auto;overflow-x:hidden;word-break:break-all;margin-top:36px; width:19%;padding: 5px;background:#f7f7f7;">
    <div id="external-events" style="width:100%;overflow:hidden;"></div>
   </div>
