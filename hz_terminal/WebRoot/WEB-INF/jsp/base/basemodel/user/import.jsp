...
$(function(){		
		$("#userUP").uploadify({
            ...
            script:  basePath+"Main/user/importuserSave",
...
function onComplete(event, queueId, fileObj, response, data){	
	...
	if(obj.success){
		...
		$('#_userlist_data').datagrid('reload'); 
		var msg = obj.msg;
		if(obj.errorStr!=''){
	  ...
	  <div data-options="region:'center',border:false">
	    <table class="sp-table" width="100%" cellpadding="0" cellspacing="0">
	    		<tr>
				<td class="sp-td1">用户上传模板文件：</td>
		    	<td>
		    	<div  style="height:25px;font-size:12px;line-height:25px;">
					<a class="btnAttach" title="请点击另存为"></a><a title="请点击另存为" target="_blank" href="Main/template/download/1">用户导入模板<a/>
				</div>
				</td>
		    	</tr>
		    	<tr>
