...
<div class="easyui-layout" data-options="fit:true">
	<form id="form1" method="post" action="<%=basePath%>Main/department/save"
		...
		<table id="table" class="sp-table" width="100%" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td>
					<input type="text" name="t_Sys_Department.d_number" id="dnumber" required="true"
						...
						validType="checkCode['<%=basePath%>Main/department/ifExistCode','code']" invalidMessage="部门编码已存在" />
				</td>
			</tr>
			<tr>
				<td class="sp-td1">部门类别</td>
				<td>
					<select class="easyui-combobox" name="t_Sys_Department.d_type" panelHeight="auto" style="width: 100px;"
			...
			<tr>
				...
				<td>
					<input type="text" name="t_Sys_Department.dtmfkey" class="easyui-numberbox" data-options="max:999,icons:iconClear"
						style="width: 200px;" />
				</td>
			</tr>
			<tr>
				<td class="sp-td1">坐席设置</td>
				<td>
					<input type="text" name="t_Sys_Department.seatids" data-options="prompt:'请输坐席',icons:iconClear"
						class="easyui-textbox" style="width: 200px;" />
				</td>
			</tr>
			<tr>
