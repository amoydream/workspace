...
%>
 ...
 <div class="easyui-layout"  data-options="fit:true">
		...
		<a href="javascript:void(0);" class="easyui-linkbutton"  onclick="task_doSearch()" data-options="iconCls:'icon-search',plain:true">查询</a>
			...
			<table id="taskGrid" class="easyui-datagrid"  data-options="url:'Main/mobileuser/getTaskList?userid=${userid}',pagination:true"  cellspacing="0" cellpadding="0" height="92%" width="100%"> 
			    <thead> 
			        <tr> 
			            ...
			            <th field="TIME"  width="15%">发送时间</th> 
			            <th field="STATUS"  width="10%" formatter="sendStatus">完成状态</th> 
			            <th field="SENDSTATUS"  width="10%" formatter="pushStatus">推送状态</th> 
			        </tr> 
			    </thead> 
			</table> 
		</div>
