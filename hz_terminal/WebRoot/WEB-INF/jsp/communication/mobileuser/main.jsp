...
%>
	...
	$(function(){
		var attrArray={
				...
				toolbar: [
                  ...
                  { text: '发送记录',iconCls: 'icon-search',handler:searchTaskList}
                 ],
				fitColumns : true,
				idField:'ID',
				rownumbers:true,/*  
	...
	function userview(){
		...
		var attrArray={
				...
				height: 300,
				width:500,
				href: '<%=basePath%>Main/mobileuser/userview/'+node.ID,
				buttons:[{
					text:'关闭',
					iconCls:'icon-no',
					handler:function(){
	...
	function sendtask(id){
		var attrArray={
				...
				height: 300,
				width:700,
				href: '<%=basePath%>Main/mobileuser/sendtask?id='+id,
		};
	...
	function searchTaskList(){
		...
		var attrArray={
				...
				height: 400,
				width:800,
				href: 'Main/mobileuser/getTaskView/'+node.ID,
				buttons:[]
		};
