...
<form id="linkman_form" method="post" action="<%=basePath%>Main/mailbook/importSave"
	style="width: 100%;">
	...
	<table class="sp-table" width="100%" cellpadding="0" cellspacing="0">
		    ...
		    <td>
		    <input id="namenum" name="namenum"  type="text" class="easyui-textbox"  data-options="required:true" style="width: 200px;"/></td>
		    <td class="sp-td1">邮箱列数：</td>
		    <td>
		    <input id="telnum" name="mailnum" type="text" class="easyui-textbox" data-options="required:true"  style="width: 200px;"/></td>
		    </tr>
		    <tr>
		    <td class="sp-td1">单位列数：</td>
		    <td>
		    <input id="deptnum" name="deptnum" type="text" class="easyui-textbox" data-options="required:true"  style="width: 200px;"/></td>
			<td class="sp-td1">职位列数：</td>
			<td>
			<input id="positionnum" name="positionnum" type="text" class="easyui-textbox" data-options="required:true"  style="width: 200px;"/>
			</td>
		    </tr>
		    <tr>
			<td class="sp-td1">备注列数：</td>
			<td colspan="3">
			<input id="remarknum" name="remarknum" type="text" class="easyui-textbox" data-options="required:true"  style="width: 200px;"/>
			</td>
		    </tr>
