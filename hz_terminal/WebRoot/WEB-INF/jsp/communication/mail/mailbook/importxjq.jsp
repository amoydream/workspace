...
<form id="linkmanq_form" method="post" action="<%=basePath%>Main/mailbook/importxjqSave"
	style="width: 100%;">
	...
	<table class="sp-table" width="100%" cellpadding="0" cellspacing="0">
			...
			<td>
			<input  type="hidden" name="t_Bus_Mailbook_Qun.pid" value="${qun.id }"/>
			<input  value="${qun.name }" type="text" class="easyui-textbox" readonly="readonly" style="width: 200px;"/>
			</td>
			<td class="sp-td1">群组名称：</td>
			<td>
			<input type="text" id="qunname" name="t_Bus_Mailbook_Qun.name" class="easyui-textbox" data-options="required:true"  style="width: 200px;"/>
			</td>
		    </tr>
	        <tr>
		    ...
		    <td>
		    <input id="mailnum" name="mailnum" value="2" type="text" class="easyui-textbox" data-options="required:true"  style="width: 200px;"/></td>
		    </tr>
		    <tr>
