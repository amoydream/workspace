...
<form id="linkmanq_form" method="post" action="<%=basePath%>Main/mailbook/importqSave"
	style="width: 100%;">
	...
	<table class="sp-table" width="100%" cellpadding="0" cellspacing="0">
			...
			<td colspan="3">
			<input id="qunname" name="qunname" value="${qun.name }" type="text" class="easyui-textbox" data-options="required:true"  style="width: 595px;"/>
			</td>
		    </tr>
	        <tr>
