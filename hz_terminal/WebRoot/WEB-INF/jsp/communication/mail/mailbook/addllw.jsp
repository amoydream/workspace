...
<form id="linkman_form" method="post" action="<%=basePath%>Main/mailbook/llwSave"
	style="width: 100%;">
 	<input type="hidden" name="act" value="add"/>
	<table class="sp-table" width="100%" cellpadding="0" cellspacing="0">
	        <tr>
		    <td class="sp-td1">群组姓名：</td>
		    <input type="hidden" name="t_Bus_Mailbook_Qun.id" value="${qun.id }"/>
		    <td><input id="lmqname" value="${qun.name }" name="t_Bus_Mailbook_Qun.name" type="text" class="easyui-textbox" data-options="required:true"  style="width: 300px;"/></td>
		    </tr>
		    <tr>
