...
function impmodel(pid){
 ...
 <div class="easyui-layout"  data-options="fit:true">
	    ...
	    <table  id="table" class="sp-table" width="100%" style="table-layout:fixed" cellpadding="0" cellspacing="0">
		    	<tr>
           ...
           <c:if test="${!pert:hasperti(applicationScope.model_save, loginModel.xdlimit)&&xgflag}">
           <a href="javascript:infosave();" class="easyui-linkbutton" data-option="iconCls:'icon-ok', plain:true'">保存</a>
           </c:if>
           <c:if test="${type==null&&!pert:hasperti(applicationScope.presch_impmodel, loginModel.xdlimit)&&xgflag}">
