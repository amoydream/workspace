...
%>
	 <form id="planMgform" method="post" action="<%=basePath %>Main/planMg/save" style="width:100%;">
	    <input type="hidden" name="act" value="add_pinformation"/>
	     <input type="hidden" name="t_Bus_PlanItem.preschid" value="${preschid}"/>
	      <input type="hidden" name="t_Bus_PlanItem.planitemcode" value="D000"/>
	    <table class="sp-table" width="100%" cellpadding="0" cellspacing="0">
		    	<tr>
		    	<td class="sp-td1">通知单位：</td>
		    	<td>
		    		<input class="easyui-combotree" name="t_Bus_PlanItem.itemid" 
		    		data-options="url:'<%=basePath%>Main/plan/getDeptTree',method:'get',editable:false,required:true,icons:iconClear" 
		    		style="width:180px;">
		    	</td>
		    	</tr>
		    	<tr>
