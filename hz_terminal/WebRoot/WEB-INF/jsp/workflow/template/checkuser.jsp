...
%>
  ...
  $(function(){
	//绑定单选事件
		$(":radio[name='uradio']").click(function(){
			...
			if(ra=='user'){
				$("#usertable").treegrid({
					url:'<%=basePath%>Main/wfTemplate/getCheckData',
					idField:'D_ID',    
				    treeField:'D_NAME',
				...
				$("#usertable").treegrid({
					...
					idField:'ID',    
				    treeField:'CHECKNAME',
					queryParams:{checktype:'role'},
					columns:[[{title:'角色',field:'CHECKNAME',width:180}]],
					fitColumns : true,
					nowrap: false, 
			        striped: true, 
			        border: true,
 ...
 <div class="easyui-layout"  data-options="fit:true">
	 ...
	 <div id="dbasource_tb" style="margin-top: 5px;margin-left: 5px;">
			...
			<input name="uradio" type="radio" value="role" ><span>角色</span>
		</div>
	 </div>
