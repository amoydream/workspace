    ...
    $(function() {
	    var attrArray = {
	        ...
	        //		height:350,formId:'templateform',isNoParam:true}}, '-', 
	        {
	            ...
	            handler : createWordTemp
	        }, '-', {
	            text : '新增excel模板',
	            title : '新增excel模板',
	            iconCls : 'icon-pageedit',
	            handler : createExcelTemp
	        }, '-', {
	            text : '修改',
	            title : '修改模板',
	            iconCls : 'icon-pageedit',
	            ...
	            iconCls : 'icon-delete',
	            delParams : {
		            url : basePath + 'Main/template/delete'
	            }
	        }],
	        fitColumns : true,
	        idField : 'ID',
...
<div class="easyui-layout" data-options="fit:true">
	<div data-options="region:'north',border:false" style="padding: 5px; background: #f7f7f7;">
		...
		<a href="javascript:void(0);" class="easyui-linkbutton" onclick="template_doSearch()"
