...
function ephoneClickFN_c(){
	var phone = $("#_evphone_c").val();
	var eid = '${t.id}';
...
function ephoneRECEClickFN_c(){
	var phone = $("#_evphoneRECE_c").val();
	var eid = '${t.id}';
	if(phone==null || phone=='' || phone==undefined){
		alert("请输入电话号码进行拨打！");
		return;
...
function ephoneAddClickFN_c(){
	var phone = $("#_evphone_c").val();
	var pname = $("#_evphname_c").val();
	if(phone==null || phone=='' || phone==undefined){
	 ...
	 <form id="emerganceform" method="post" action="<%=basePath %>Main/event/save" style="width:100%;">
	    ...
	    <table  id="table" class="sp-table" width="100%" cellpadding="0" cellspacing="0">
		    	...
		    	<tr>
			    	...
			    	<td colspan="3">
			    		<input type="text" id="_evphoneRECE_c" name="t_Bus_EventInfo.ev_recetel"  value="${t.ev_recetel}"
			    		data-options="prompt:'请输入接报人电话',icons:[{iconCls:'icon-phonereceived',handler:ephoneRECEClickFN_c}]" class="easyui-textbox" style="width: 180px;"/></td>
			    	</td>
		    	</tr>
		    	...
		    	<td >
		    		<input type="text" id="_evphname_c" name="t_Bus_EventInfo.ev_reporter" data-options="prompt:'请输入报告人姓名',icons:iconClear" 
		    	...
		    	<td >
		    		<input type="text" id="_evphone_c" name="t_Bus_EventInfo.ev_reporttel" 
		    		data-options="prompt:'请输入报告人电话',required:true,icons:[{iconCls:'icon-phonereceived',handler:ephoneClickFN_c},{iconCls:'icon-reportedit',handler:ephoneAddClickFN_c}]" 
