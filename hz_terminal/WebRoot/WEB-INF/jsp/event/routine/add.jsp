...
$("#evTxfile_"+id).remove();
	 ...
	 <form id="routineform" method="post" action="<%=basePath %>Main/eventRoutine/save" style="width:100%;">
	    ...
	    <table  id="table" class="sp-table" width="100%" cellpadding="0" cellspacing="0">
		    	...
		    	<td colspan="3">
		    	<input type="text" name="t_Bus_EventInfo.ev_name" data-options="prompt:'请输入事件名称',required:true,icons:iconClear" class="easyui-textbox" style="width: 565px;"/></td>
		    	</tr>
		    	<tr>
		    	<td class="sp-td1">事发单位：</td>
		    	<td colspan="3">
		    		<input class="easyui-combotree" name="t_Bus_EventInfo.organid" data-options="url:'<%=basePath%>Main/event/getComboTree',method:'get'" style="width:565px;">
		    	</td>
		    	...
		    	<td >
		    		<input type="text" name="t_Bus_EventInfo.ev_receername" data-options="prompt:'请输入接报人姓名',icons:iconClear" class="easyui-textbox" style="width: 180px;"/>
		    	</td>
		    	<td class="sp-td1">接报人电话：</td>
		    	<td >
		    		<input type="text" name="t_Bus_EventInfo.ev_recetel" data-options="prompt:'请输入接报人电话',icons:iconClear,value:'${ev_reporttel}'" class="easyui-textbox" style="width: 180px;"/>
		    	</td>
		    	</tr>
		    	...
		    	<td >
		    		<input type="text" name="t_Bus_EventInfo.ev_reporter" data-options="prompt:'请输入报告人姓名',icons:iconClear" class="easyui-textbox" style="width: 180px;"/>
		    	</td>
		    	<td class="sp-td1">报告人电话：</td>
		    	<td >
		    		<input type="text" name="t_Bus_EventInfo.ev_reporttel" data-options="prompt:'请输入报告人电话',required:true,icons:iconClear,value:'${ev_reporttel}'" class="easyui-textbox" style="width: 180px;"/>
		    	</td>
		    	</tr>
		    	<tr>
		  		<td class="sp-td1">事发地点：</td>
		    	<td colspan="3">
		    	<input class="easyui-combotree" name="t_Bus_EventInfo.occurarea" data-options="url:'<%=basePath%>Main/event/getoccurAreaTree',method:'get',editable:false" style="width:180px;">
		    	（区/县）
		    	<input type="text" name="t_Bus_EventInfo.ev_address" data-options="prompt:'请输入事发地点',icons:iconClear" class="easyui-textbox" style="width: 328px;"/>
		    	</td>
		    	</tr>
		    	...
		    	<td >
		    		<select class="easyui-combobox" name="t_Bus_EventInfo.ev_usestatus"  panelHeight="auto" code="EVUS" style="width: 180px;" data-options="editable:false,icons:iconClear" ></select>
		    	</td>
		    	<td  class="sp-td1" >报送时效：</td>
		    	<td >
		    		<select class="easyui-combobox" name="t_Bus_EventInfo.ev_bssx"  panelHeight="auto" code="EVSX" style="width: 180px;" data-options="editable:false,icons:iconClear" ></select>
		    	</td>
		    	</tr>
		    	<tr>
