...
$("#evTxfile_"+id).remove();
	 ...
	 <form id="emerganceform" method="post" action="<%=basePath %>Main/event/save" style="width:100%;">
	    ...
	    <table  id="table" class="sp-table" width="100%" cellpadding="0" cellspacing="0">
		    	...
		    	<td colspan="5">
		    	<input type="text" name="t_Bus_EventInfo.ev_name" data-options="prompt:'请输入事件名称',required:true,icons:iconClear" class="easyui-textbox" style="width: 800px;"/></td>
		  		</tr>
		  		<tr>
		    	...
		    	（区/县）
		    	<input type="text" name="t_Bus_EventInfo.ev_address" data-options="prompt:'请输入事发地点',icons:iconClear" class="easyui-textbox" style="width: 560px;"/></td>
		    	</tr>
		    	...
		    	<td >
		    		<input class="easyui-combotree" name="t_Bus_EventInfo.organid" data-options="url:'<%=basePath%>Main/event/getComboTree',method:'get',icons:iconClear" style="width:180px;">
		    	</td>
		    	...
		    	<tr>
		    		...
		    		<td >
		    		<input type="text" name="t_Bus_EventInfo.ev_receername" data-options="prompt:'请输入接报人姓名',icons:iconClear" class="easyui-textbox" style="width: 180px;"/></td>
		    		</td>
		    		
		    		<td  class="sp-td1" >接报人电话：</td>
			    	<td colspan="3">
			    		<input type="text" name="t_Bus_EventInfo.ev_recetel" data-options="prompt:'请输入接报人电话',icons:iconClear" class="easyui-textbox" style="width: 180px;"/></td>
			    	</td>
		    	</tr>
		    	...
		    	<td >
		    		<input type="text" name="t_Bus_EventInfo.ev_reportAddress" data-options="icons:iconClear" class="easyui-textbox" style="width: 180px;"/>
		    	</td>
