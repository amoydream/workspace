...
function eventPlan(){
 ...
 <div class="easyui-layout"  data-options="fit:true">
	    ...
	    <table  id="table" class="sp-table" width="100%" cellpadding="0" cellspacing="0">
		    	...
		    	<td colspan="3">
		    		${t.ev_recetel}<c:if test="${!empty t.ev_recetel}">
		    		<a href="javascript:void(0);" onclick="callout('${t.ev_recetel}','${t.id}') " class="easyui-linkbutton"  data-options="iconCls:'icon-phonereceived'"></a>
		    		</c:if>
		    	</td>
		    	</tr>
		    	<tr>
		    	...
		    	<td >
		    		${t.ev_reporttel}<c:if test="${!empty t.ev_reporttel}">
