...
poCtrl1.setSaveFilePage(basePath+"Main/eventDuty/pageSave/"+id);
...
poCtrl1.setTagId("evDutyReportView"); //此行必须 
%>
...
function Save() {
	document.getElementById("evDutyReportView").WebSave();
	window.close();
}
function SaveAs(){
	document.getElementById("evDutyReportView").ShowDialog(3);
}
//打印
function ShowPrintDlg() {
    document.getElementById("evDutyReportView").ShowDialog(4); //打印对话框
}
//打开本地文件
function openLCfile(){
	document.getElementById("evDutyReportView").ShowDialog(1);
}
</script>
</head>
<body>
<div style="height: 100%;float: left;margin: 0 auto;padding: 0 auto;width: 100%;">
	<po:PageOfficeCtrl id="evDutyReportView" />
</div>
</body>
</html>