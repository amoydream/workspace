...
%>
	...
	function e_doSearch(){
		$('#eventSearchGrid').datagrid('load',{
			...
			stime:$('#starttime3').datebox('getValue'),
	        etime:$('#endtime3').datebox('getValue')
		});
	}
	function evtelFN_s(val, row, index){
 ...
 <div class="easyui-layout"  data-options="fit:true">
		<div data-options="region:'north',border:false" style="padding: 5px;background:#f7f7f7;">
			...
			<span>记录时间：</span>
		<input class="easyui-datebox" id="starttime3" data-options="editable:false,icons:iconClear" style="width: 180px;">
		<span>至</span>
		<input class="easyui-datebox" id="endtime3" data-options="editable:false,icons:iconClear" style="width: 180px;">
			...
			<table id="eventSearchGrid" cellspacing="0" cellpadding="0"> 
			    <thead> 
			       ...
			       <!--  <th field="EV_DATE" width="100"  >事发时间</th> -->
			        <th field="EV_REPORTTEL" width="100"  formatter="evtelFN_s" >报告人电话</th>
