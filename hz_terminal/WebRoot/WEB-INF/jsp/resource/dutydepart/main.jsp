...
<%@ include file="/include/inc.jsp"%>
	...
	function zTreeOnClick(event, treeId, treeNode){
		...
		$.getJSON("<%=basePath%>Main/dutydepart/getDepartInfo", 
				...
				function(json){
					$("#or_name").text(json.organ.OR_NAME);
	...
	$(function(){
		...
		dutydepartree.expandNode(node);
			...
			<div data-options="region:'center',border:false">
				<div class="easyui-panel" style="height:114px;" data-options="collapsible:true" title="职能部门信息">
					 <table id="tables" class="sp-table" width="100%" cellpadding="0" cellspacing="0">
					 	<tr>
					 		<td class="sp-td1">机构名称</td>
					 		<td id="or_name">${busorgList[0].or_name}</td>
				...
				<div id="dutytabs" class="easyui-tabs" style="width:100%" data-options="fit:true, tabPosition:'left',headerWidth:90">
