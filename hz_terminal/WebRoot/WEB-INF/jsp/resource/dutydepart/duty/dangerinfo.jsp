...
%>
	...
	$(function(){
		var attrArray={
				...
				rownumbers:true,/*  
				frozenColumns:[[]], */
				url:"<%=basePath%>Main/danger/getGridData/${deptid}" ,
		...
		$.lauvan.dataGrid("dangerGrid2",attrArray);
		
	});
	function danger_doSearch(){
		$('#dangerGrid2').datagrid('load',{
			dangername: $('#dangername11').val()
		});	
	}
	</script>
 ...
 <div data-options="region:'north',border:false" style="padding: 5px;background:#f7f7f7;">
		<span>名称:</span>
		<input id="dangername11" type="text" class="easyui-textbox" >
		...
		<div data-options="region:'center',border:false">
			<table id="dangerGrid2"   cellspacing="0" cellpadding="0" width="100%"> 
			    <thead> 
			        <tr> 
