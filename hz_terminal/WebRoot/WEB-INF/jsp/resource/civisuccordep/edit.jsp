  ...
  <script>
  	...
  	$(function(){
		...
		function onComplete(event, queueId, fileObj, response, data){
			...
			if($("#civilphoto").length>0){
				delFile($("#photoid").val());
			}
			var photohtml =  "<input type='hidden' id='photoid' name='t_Civisuccordep.photo' value='"+obj.id+"' /><img src='" + basePath+obj.url + "' style='width:135px;height:85px;float:left;' />";
