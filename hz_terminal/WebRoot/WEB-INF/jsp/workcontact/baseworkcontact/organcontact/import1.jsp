...
$(document).ready(function()
        {
            $("#uploadify").uploadify({
                ...
                'script': '<%=basePath%>Main/attachment/save/linkorgan--${userid}',
...
<form id="organ_form" method="post" action="<%=basePath%>Main/organcontact/importSave"
	style="width: 100%;">
	...
	<table class="sp-table" width="100%" cellpadding="0" cellspacing="0">
	        ...
	        <td colspan="4" class="call-td">
		        ...
		        <li><span>注：如果上级机构空白，则默认上级机构为“组织机构”</span></li>		     
		    	</ul>
		    	</td>	
	        </tr>
	        <tr>
			<td class="sp-td1">机构名称列数：</td>
			<td>
			<input id="orgnamenum" name="orgnamenum" value="1" type="text" class="easyui-textbox" data-options="required:true"  style="width: 200px;"/>
			</td>			
		    <td class="sp-td1">上级机构列数：</td>
		    <td>
		    <input id="sonamenum" name="sonamenum" value="2" type="text" class="easyui-textbox"  data-options="required:true" style="width: 200px;"/>
		    </td>
		    </tr>
	        <tr>
		    <td class="sp-td1">办公电话列数：</td>
		    <td>
		    <input id="telnum" name="telnum" value="3" type="text" class="easyui-textbox" data-options="required:true"  style="width: 200px;"/></td>
		    <td class="sp-td1">传真列数：</td>
		    <td>
		    <input id="faxnum" name="faxnum" value="4" type="text" class="easyui-textbox" data-options="required:true"  style="width: 200px;"/></td>
		    </tr>
		    <tr>
			<td class="sp-td1">Email列数：</td>
			<td>
			<input id="emailnum" name="emailnum" value="5" type="text" class="easyui-textbox" data-options="required:true"  style="width: 200px;"/>
			</td>
			<td class="sp-td1">地址列数：</td>
			<td colspan="3">
			<input id="addressnum" name="addressnum" value="6" type="text" class="easyui-textbox" data-options="required:true"  style="width: 200px;"/>
			</td>
		    </tr>		 		    
		    <tr>
