...
public class T_Receive_Doc extends Model<T_Receive_Doc> {
	...
	//接收公文
	public Page<Record> getrGridPage(Integer pageNum, Integer pageSize, String code, String name, LoginModel loginModel) {
	...
	//获取发送公文
	public Page<Record> getsGridPage(Integer pageNum, Integer pageSize, String code, String name, LoginModel loginModel) {
		pageNum = pageNum == null || pageNum < 1 ? 1 : pageNum;
		pageSize = pageSize == null || pageSize < 1 ? JFWebConfig.pageSize : pageSize;
		String sql = "select t.*,u.user_name as sendername";
		StringBuffer str = new StringBuffer();
