...
public class EmergencyContactController extends BaseController {
	...
	public void getGridData() {
		...
		// 获取表格表页数据
		Page<Record> page = T_Bus_EmergencyContact.dao.getContactPage(pageSize, pageNumber, bookids, personids);
	...
	public void getTreeData() {
		...
		List<Record> emergencyList = T_Bus_EmergencyContact.dao.getAllEmergencys();
	...
	public void deletePerson() {
		...
		try {
			...
			if(plist.size() != 0) {
				...
				String[] newpidsArr = oldplist.toArray(new String[oldplist.size()]);
			...
			if(blist.size() != 0) {
				...
				String[] newbidsArr = oldblist.toArray(new String[oldblist.size()]);
