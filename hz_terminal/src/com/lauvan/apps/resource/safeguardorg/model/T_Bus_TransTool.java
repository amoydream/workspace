...
public class T_Bus_TransTool extends Model<T_Bus_TransTool> {
	...
	public Page<Record> getPage(Integer pageSize, Integer pageNumber, String toolname, String firmname, String transtypeid) {
	...
	public T_Bus_TransTool getById(String id) {
		String sql = "select t.*, t2.transtype,f.firmname from t_bus_transtool t ,t_bus_transfirm f , t_bus_transtype t2 " + "where t.transtypeid = t2.transtypeid and t.firmid = f.firmid and t.toolid =" + id;
