...
public class ChannelController extends BaseController {
	...
	public void save() {
		...
		try {
			...
			if(success) {
				...
				renderText("{\"success\":true, \"msg\":\"保存成功！\",\"dialogid\":\"channelDialog\", \"gridid\":\"channel_data\", \"treeObj\":\"channeltree\",\"reloadid\":" + (getPara(0) == null ? channel.get("parentid") : getPara(0)) + ",\"idkey\":\"d_id\"}");
			} else {
	...
	public void ifExistChannel() {
		...
		if(channel == null) {
			...
			if(channelid != null && !"".equals(channelid) && channel.getBigDecimal("channelid").intValue() == channelid) {
				tips.put("success", false);
			} else {
