...
public class ContentController extends BaseController {
	...
	public void save() {
		...
		try {
			...
			//判断文章类型
			if("1".equals(content.getStr("contenttype")) && content.get("imageid") != null) {
			...
			if(content.get("contentid") == null) {
				...
				if(c.get("imageid") != null && (content.get("imageid") == null || !c.get("imageid").toString().equals(content.get("imageid").toString()))) { //如果是新上传的图片，则删除旧图片
