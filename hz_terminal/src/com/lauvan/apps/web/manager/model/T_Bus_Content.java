...
public class T_Bus_Content extends Model<T_Bus_Content> {
	...
	public T_Bus_Content getById(Integer id) {
		String sql = "select c.* , a.url as fjurl,c2.channelname from t_bus_content c left join t_attachment a on c.imageid=a.id " + "left join t_bus_channel c2 on c.channelid = c2.channelid where c.contentid = " + id;
