...
public class BrowserExample {
	static final String		iconLocation	= "icon.ico";
	static final String[]	imageLocations	= {"home.gif", "home.gif", "home.gif", "home.gif", "home.gif", "home.gif", "home.gif", "home.gif", "home.gif", "home.gif", "home.gif", "home.gif",};
	static ResourceBundle	resourceBundle	= ResourceBundle.getBundle("webrowser");

	public static void main(String[] args) {
		Display display = new Display();
		Shell shell = new Shell(display);
		shell.setLayout(new FillLayout());
		shell.setText(BrowserExample.getResourceString("Title"));
	...
	void initResources() {
			...
			try {
				if(images == null) {
					...
					for(int i = 0; i < BrowserExample.imageLocations.length; ++i) {
						InputStream sourceStream = getClass().getResourceAsStream(BrowserExample.imageLocations[i]);
		...
		String error = BrowserExample.resourceBundle != null ? BrowserExample.getResourceString("CouldNotLoadResources") : "Unable to load resources";
		freeResources();
