...
public class  T_Civisuccordep extends Model<T_Civisuccordep>{
	...
	public Record getById(String id){
		if(id.matches("[0-9]+")){
			String sql = "select c.* , a.url,u.user_name as username from t_civisuccordep c left join t_attachment a on c.photo = a.id " +
					"left join t_sys_user u on c.recid =  u.user_id where c.deptid = "+id;
