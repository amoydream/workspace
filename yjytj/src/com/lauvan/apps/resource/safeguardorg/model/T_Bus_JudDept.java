...
public class T_Bus_JudDept extends Model<T_Bus_JudDept>{
	...
	public Page<Record> getPage(Integer pageSize, Integer pageNumber,Integer pid,
			String juddeptname, String levelcode) {
	...
	public String getChildIdsByDeptids(String deptids){
		String sql = "select wm_concat(j.deptid) from t_bus_juddept j start with j.deptid in (" 
			+ deptids + ") connect by prior j.deptid = j.superdept_id";
		return Db.queryStr(sql);
	}
