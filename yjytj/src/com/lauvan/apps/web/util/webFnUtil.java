...
public class webFnUtil {
	 ...
	 * @return
	 */
	public static Page<Record> contents(Integer pageSize,Integer pageNumber,
			String channelpath, String contenttype) {
		...
		Page<Record> page = 
			T_Bus_Content.dao.getPage(pageSize, pageNumber, c.getBigDecimal("channelid").intValue(), null, sqlWhere, "releasedate", "desc");
