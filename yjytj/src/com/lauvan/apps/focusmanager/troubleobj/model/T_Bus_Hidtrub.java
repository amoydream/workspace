...
public class T_Bus_Hidtrub extends Model<T_Bus_Hidtrub> {
	...
	public List<Record> getListByName(String name) {
		String sql="select t.*,decode(t.hidtrubtype,null,'',(select a.p_name from t_sys_parameter a where a.p_acode=t.hidtrubtype  Start With a.p_acode='YHDLB' Connect By  Prior a.id = a.sup_id  ))  as hidtrubtype_name "
				+" from t_bus_hidtrub t where 1=1";
		if(name!=null && !"".equals(name)){
