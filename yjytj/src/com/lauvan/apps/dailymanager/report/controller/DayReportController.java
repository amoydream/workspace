...
public class DayReportController extends BaseController {
	...
	public void getGridData() {
		...
		if (username != null && !"".equals(username)) {
			sqlWhere.append(" and r_username like '%").append(username)
					.append("%'");
		}
		Page<Record> page = Paginate.dao.getPage("t_bus_report", pageSize,
				pageNumber, sqlWhere.toString(), "r_id", "desc");
	...
	public void save() {
		...
		try {
			...
			if (success) {
				toDwzText(true, msg, "", "dayReportDialog", "dayreportGrid",
						"closeCurrent");
			} else {
				toDwzText(false, msg, "", "", "", "");
			}
