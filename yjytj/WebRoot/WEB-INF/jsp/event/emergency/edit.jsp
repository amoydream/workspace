	...
	tel_addWN(phone, pname);
	 ...
	 <form id="emerganceform" method="post" action="<%=basePath %>Main/event/save" style="width:100%;">
	    ...
	    <table  id="table" class="sp-table" width="100%" cellpadding="0" cellspacing="0">
		    	...
		    	class="easyui-textbox" style="width: 240px;" value="${t.ev_address}"/></td>
		    	</tr>
		    	...
		    	<td >
		    		<input class="easyui-combotree" name="t_Bus_EventInfo.organid"
		    		 data-options="url:'<%=basePath%>Main/department/getComboTree',method:'get',value:'${t.organid}',icons:iconClear" style="width:180px;">
		    	</td>
		    	...
		    	<td >
		    		<input type="text" id="_evphname" name="t_Bus_EventInfo.ev_reporter" data-options="prompt:'请输入报告人姓名',required:true,icons:iconClear" 
		    	...
		    	<td colspan="2">
		    		...
		    		data-options="validType:'length[0,1000]'"  style="width: 270px;height: 40px;" >${t.ev_ships}</textarea>
		    	</td>
		    	
		  		<td class="sp-td1">事件基本情况</td>
		    	<td colspan="2">
		    		<textarea name="t_Bus_EventInfo.ev_basicsituation" class="textarea" 
		    		data-options="validType:'length[0,500]'"  style="width: 270px;height: 40px;" >${t.ev_basicsituation}</textarea>
		    	</td>
		    	</tr>
