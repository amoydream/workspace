...
<script type="text/javascript">
	...
	function zTreeOnClick_evsms(event, treeId, treeNode) {
		if(treeNode.id=='gzllw'||treeNode.pid=='gzllw'
			...
			$('#eventsmsGrid').datagrid({url:'<%=basePath%>Main/smsMg/getSmsList/'+treeNode.id+"-"+treeNode.pid});
		}
	};
