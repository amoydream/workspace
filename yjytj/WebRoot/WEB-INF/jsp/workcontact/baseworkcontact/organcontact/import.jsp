...
$(function(){		
		$("#userUP").uploadify({
            ...
            script:  basePath+"Main/organcontact/importSave",
	...
	if(obj.success){
	  ...
	  <div data-options="region:'center',border:false">
	    <table class="sp-table" width="100%" cellpadding="0" cellspacing="0">
	    		<tr>
				<td class="sp-td1" style="width: 150px;">日常组织机构通讯录模板：</td>
		    	<td>
		    	<div  style="height:25px;font-size:12px;line-height:25px;">
					<a class="btnAttach" title="请点击另存为"></a><a title="请点击另存为" target="_blank" href="Main/template/download/11">日常组织机构通讯录模板<a/>
				</div>
				</td>
		    	</tr>
		    	<tr>
