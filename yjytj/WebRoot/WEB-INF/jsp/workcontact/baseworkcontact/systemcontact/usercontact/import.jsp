...
$(function(){		
		$("#usercontactUP").uploadify({
            ...
            script:  basePath+"Main/systemcontact/usercontact/importusercontactSave",
...
function onComplete(event, queueId, fileObj, response, data){	
	...
	if(obj.success){
		...
		$('#_usercontactlist_data').datagrid('reload'); 
		var msg = obj.msg;
		if(obj.errorStr!=''){
	  ...
	  <div data-options="region:'center',border:false">
	    <table class="sp-table" width="100%" cellpadding="0" cellspacing="0">
	    		<tr>
				<td class="sp-td1" style="width: 150px;">应急人员通讯录模板：</td>
		    	<td>
		    	<div  style="height:25px;font-size:12px;line-height:25px;">
					<a class="btnAttach" title="请点击另存为"></a><a title="请点击另存为" target="_blank" href="Main/template/download/8">应急人员通讯录模板<a/>
				</div>
				</td>
		    	</tr>
		    	<tr>
