...
require(["<%=basePath%>plugins/gis/main.js","esri/dijit/InfoWindow","esri/geometry/webMercatorUtils","esri/dijit/Print","esri/tasks/PrintTask","esri/tasks/PrintParameters","esri/tasks/PrintTemplate"],
	...
	<c:if test="${flag == true}">
		...
		<div class="op3">
			<a href="#" style="display: inline-block ; padding-left:16px; word-wrap:no-wrap "  class="aBtn show">显示</a>
			<a href="#" style="display: inline-block ; padding-left:16px; word-wrap:no-wrap "  class="aBtn">隐藏</a>
		</div><!--op3-->
	</c:if>
	<div class="op4">
