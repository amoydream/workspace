	...
	$(function(){
		var attrArray={
				...
				toolbar: [
						  ...
						  { text:'添加', title:'添加装备信息', iconCls: 'icon-add',
								dialogParams:{dialogId:'teamEquipDialog', href:'<%=basePath%>Main/teamequip/add/${team.tea_id}', 
								width:700, height:560, formId:'form1', isNoParam:true},permitParams:'${pert:hasperti(applicationScope.teameqAdd, loginModel.xdlimit)}'}, '-',
						  { text: '修改', title:'修改装备信息',iconCls: 'icon-pageedit',
									  dialogParams:{dialogId:'teamEquipDialog',href:'<%=basePath%>Main/teamequip/edit',width:700,
									height:560,formId:'form1'},permitParams:'${pert:hasperti(applicationScope.teameqEdit, loginModel.xdlimit)}'}, '-',
						  { text: '删除',iconCls: 'icon-delete',delParams:{url:'<%=basePath%>Main/teamequip/delete'},permitParams:'${pert:hasperti(applicationScope.teameqDel, loginModel.xdlimit)}'}
