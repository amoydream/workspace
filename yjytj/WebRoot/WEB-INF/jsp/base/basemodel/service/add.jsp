...
<%@ include file="/include/inc.jsp"%>
	 ...
	 <form id="serviceform" method="post" action="<%=basePath %>Main/service/save" style="width:100%;">
	    ...
	    <table  id="table" class="sp-table" width="100%" cellpadding="0" cellspacing="0">
		    	...
		    	<td >
		    	<input type="text" name="t_Sys_DataService.servicename" data-options="prompt:'请输入业务名称',required:true,icons:iconClear" class="easyui-textbox" style="width: 180px;"/></td>
		    	</tr>
		    	<tr>
		    	...
		    	<td >
		    		<input class="easyui-combotree" name="t_Sys_DataService.model_id" data-options="url:'<%=basePath%>Main/service/getModelTree',method:'get',required:true" style="width:180px;">
		    	</td>
		    	</tr>
		    	<tr>
