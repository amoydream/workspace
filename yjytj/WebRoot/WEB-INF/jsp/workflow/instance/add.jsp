	...
	htmlBody=$("#fileList").html();
	  ...
	  <div data-options="region:'north',border:false" style="height:120px;">
	    <table class="sp-table" width="100%" cellpadding="0" cellspacing="0">
		    	...
		    	<td>
		    	<input type="hidden" id="wf_id" name="t_WF_Instance.wfid" />
		    	<input type="hidden" id="wf_pointid" name="t_WF_Instance.pointid" />
		    	<input type="hidden" id="wf_ftype" name="wf_ftype" />
		    	<input type="hidden" id="wf_formid" name="wf_formid" />
				...
				<td >
		    	<input type="hidden" id="spr_id" name="spr.id" />
		    	<input id="spr_name" name="spr.name" type="text" class="easyui-searchbox"  style="width: 200px;" 
		    	...
		    	<td><input type="text" name="t_WF_Instance.name" class="easyui-textbox"  data-options="required:true"  style="width: 200px;"/>
				</td>
