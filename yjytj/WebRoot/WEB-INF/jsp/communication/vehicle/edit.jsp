...
<form id="vehicle_form" method="post" action="<%=basePath%>Main/vehicle/save"
	...
	<table class="sp-table" width="100%" cellpadding="0" cellspacing="0">
		    ...
		    <td>
		    <input id="atitleid" name="" type="text" class="easyui-textbox" data-options="required:true"  
		    value="${v.vno }" style="width: 300px;"/>
		    </td>
		    </tr>
		    <tr>
		    <td class="sp-td1">等级：</td>
		    <td>
		    <input id="atitleid" name="" type="text" class="easyui-textbox"  
		    value="${v.grade }" style="width: 300px;"/>
		    </td>
		    </tr>
	        <tr>
		    ...
		    <td>
		    <input id="atitleid" name="" type="text" class="easyui-textbox"  
		    value="${v.seatnum }" style="width: 300px;"/>
		    </td>
		    </tr>
		     <tr>
		    <td class="sp-td1">限速（km/时）：</td>
		    <td>
		    <input id="atitleid" name="" type="text" class="easyui-textbox"  value="${v.speedlimit }"
		    style="width: 300px;"/>
		    </td>
		    </tr>
	        <tr>
		    ...
		    <td>
		    <input id="atitleid" name="" type="text" class="easyui-textbox"  value="${v.address }"
		    style="width: 300px;"/>
		    </td>
		    </tr>
		    <tr>		    
		    ...
		    <td><textarea id="acontentid" name="t_Bus_Affiche.content"
					...
					style="width:300px; height:80px;">${v.info }</textarea>
		    </td>
		    </tr>		  
    </table>
</form>
