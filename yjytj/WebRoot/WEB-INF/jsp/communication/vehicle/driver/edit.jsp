...
<form id="driver_form" method="post" action="<%=basePath%>Main/vehicle/save"
	...
	<table class="sp-table" width="100%" cellpadding="0" cellspacing="0">
		    ...
		    <td>
		    <input id="atitleid" name="" type="text" value="${d.name }" class="easyui-textbox" data-options="required:true"  style="width: 300px;"/>
		    </td>
		    </tr>
	        <tr>
		    ...
		    <td>
		    <input id="atitleid" name="" value="${d.tel }" type="text" class="easyui-textbox"  style="width: 300px;"/>
		    </td>
		    </tr>	   
    </table>
</form>
