...
　　　　　　　　//如果超时就处理 ，指定要跳转的页面 　　　　　　　　
				var top = getTopAIOWinow(); //获取当前页面的顶层窗口对象 　　　　　　　　
...
　　　　　　　　	//top.location.href = "http://"+window.location.host+"/base/Login"; //跳转到登陆页面 对多服务器同样适用 　　　
				top.location.href = winAIO_getRootPath()+"/AIOLogin/index"; //跳转到登陆页面 对多服务器同样适用 　　　　
			} 
　　　　} 
});
