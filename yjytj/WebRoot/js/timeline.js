(function($) {
	if(!!window.ActiveXObject && !window.XMLHttpRequest
	   && (location.href == 'http://www.lanrentuku.com' || location.href == 'http://www.lanrentuku.com/'))
		return;
	$(function() {
		nav();
		bnrSilder();
	...
	function bnrSilder() {
		...
		(function() {
			if(navigator.userAgent.toLocaleLowerCase().indexOf('opera') >= 0)
				return;
	...
	function sideSlider() {
		...
		var $aCur = $(".help-side dl").find(".cur a"), $targetA = $(".help-side dl dd a"), $sideSilder = $(".side-slider"), curT = $aCur
		    .position().top - 3;
